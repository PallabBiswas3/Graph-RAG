...
For a fair ablation, run the exact same question against all three modes and keep the ingested corpus, retrieval index, Gemini model, and synthesis instructions fixed. The main experimental differences should be adaptive routing and claim verification.
